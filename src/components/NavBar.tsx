...
export function NavBar() {
  ...
  return (
    <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none">
      <header className="pointer-events-auto h-14 pl-6 pr-3 rounded-full border bg-background/80 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.1)] flex items-center gap-8 group/nav transition-all hover:bg-background/90 border-border/40">
        ...
        <Link to="/" className="flex items-center gap-3 group/logo">
          ...
          <div className="flex flex-col">
            <span className="text-[11px] font-black uppercase tracking-tighter leading-none">FMZ Auto</span>
